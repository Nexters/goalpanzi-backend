...
public class MissionVerificationValidator {
    ...
    public void validate(final MissionMember missionMember) {
        ...
        validateDuplication(mission, missionMember, now.toLocalDate());
        validateTime(mission, now);
    }
    ...
    private void validateDuplication(final Mission mission, final MissionMember missionMember, final LocalDate today) {
        if (isDuplicatedVerification(missionMember.getMember().getId(), mission.getId(), today)) {
    ...
    private void validateTime(final Mission mission, final LocalDateTime now) {
